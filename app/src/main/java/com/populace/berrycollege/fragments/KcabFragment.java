...
public class KcabFragment extends Fragment {
    WebView kcab;
    BerrySession bs;
    ProgressDialog pd;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_kcab, container, false);
        if (ParseDataManager.sharedDataManager(getActivity()).CheckIsConnectedToInternet(getActivity())) {
        kcab = (WebView)v.findViewById(R.id.web_kcab);
        ...
        String kcabs = bs.getString(ParseDataManager.TAG_SOCIAL_KCAB);
        kcab.loadUrl(kcabs);
    }
    else
    {
